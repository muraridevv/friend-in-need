...
public class CalendarEvent {
    ...
    public void markReminded(){ reminded = true; } public String getTitle(){ return title; } public Instant getStartsAt(){ return startsAt; } public Instant getEndsAt(){ return endsAt; }
}
