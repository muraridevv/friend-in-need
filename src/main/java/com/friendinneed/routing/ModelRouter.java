...
public class ModelRouter {
    ...
    public void refreshHealth() { openRouter.ping(openRouterUrl); voice.ping(voiceUrl); embedding.ping(embeddingUrl); }
    public ModelChoice routeChat() { return choose(openRouter); }
    public ModelChoice routeStt() { return choose(voice); }
    public ModelChoice routeTts() { return choose(voice); }
    ...
    private String statusFor(ModelChoice choice) { return choice == ModelChoice.CLOUD ? "cloud" : "local"; }
